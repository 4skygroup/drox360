...
export default function Contact() {
    ...
    return (
        <>
            <SEO
                title="Contact — DROX 360° | Agence Créative à Paris"
                description="Contactez DROX 360° pour discuter de votre projet de direction créative, stratégie de marque, production de contenu ou social media."
                path="/contact"
            />
