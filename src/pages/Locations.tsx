...
export default function Locations() {
  ...
  return (
    <>
      <SEO
          title="DROX 360° — Agence Créative à Paris et à l'International"
          description="DROX 360° accompagne les marques à Paris et à l'international grâce à une expertise créative, stratégique et digitale."
          path="/location"
      />
